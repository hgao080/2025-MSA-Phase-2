...
export default function Header() {
  ...
  return (
    <header className="top-0 z-50 absolute inset-x-0">
      ...
      <div className="absolute inset-0 bg-white/80 backdrop-blur-md border-gray-200/50 border-b"></div>
      ...
      <nav aria-label="Global" className="relative flex justify-between items-center mx-auto p-6 lg:px-8 max-w-7xl">
        ...
        <div className="lg:hidden flex">
          <button
            ...
            className="inline-flex justify-center items-center hover:bg-gray-100/50 -m-2.5 p-2.5 rounded-lg text-gray-700 transition-colors duration-200"
          >
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-8">
          <a 
            href="/" 
            className="group relative font-semibold text-gray-700 hover:text-indigo-600 text-sm transition-colors duration-200"
          >
            Home
      ...
      <Dialog open={mobileMenuOpen} onClose={setMobileMenuOpen} className="lg:hidden">
        ...
        <DialogPanel className="right-0 z-50 fixed inset-y-0 bg-white/95 sm:shadow-2xl backdrop-blur-md px-6 py-6 sm:ring-1 sm:ring-gray-200/50 w-full sm:max-w-sm overflow-y-auto">
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              className="hover:bg-gray-100/50 -m-2.5 p-2.5 rounded-lg text-gray-700 transition-colors duration-200"
            >
          ...
          <div className="flow-root mt-6">
            <div className="-my-6 divide-y divide-gray-200/30">
              <div className="space-y-2 py-6">
                <a
                  href="/"
                  className="block hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 -mx-3 px-4 py-3 rounded-xl font-semibold text-gray-900 hover:text-indigo-600 text-base transition-all duration-300"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  Home
                </a>
                ...
                {user !== null ? (
                  <>
                    ...
                    <button
                      ...
                      className="block hover:bg-red-50 -mx-3 px-4 py-3 rounded-xl w-full font-semibold text-red-600 text-base text-left transition-all duration-300"
                    >
                      Logout
                    </button>
                  </>
