...
export default function UserProjectCard({ project }: ProjectCardProps) {
  ...
  const selectedProject = useUserProjectStore(state => state.selectedProject);
  ...
  return (
    ...
    >
      ...
      <div className={`absolute inset-0 bg-gradient-to-br transition-opacity duration-300 ${
        isSelected 
          ? 'from-indigo-50/70 to-purple-50/70 dark:from-indigo-950/30 dark:to-purple-950/30 opacity-100' 
          : 'from-indigo-50/50 to-purple-50/50 dark:from-indigo-950/20 dark:to-purple-950/20 opacity-0 group-hover:opacity-100'
      }`} />
      ...
      <div className="z-10 relative">
        ...
        <div className={`absolute top-4 right-4 transition-opacity duration-200 ${
          ...
          <div className={`w-3 h-3 rounded-full ${
            isSelected 
              ? 'bg-indigo-500 ring-2 ring-white dark:ring-gray-800' 
