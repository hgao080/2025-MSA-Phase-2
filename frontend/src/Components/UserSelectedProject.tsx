											...
											<div className='flex items-center gap-4'>
												...
												<div className='flex gap-2'>
													{editedRoles.filter(role => !role.filled).length > 0 && (
														<span className='inline-flex items-center gap-1 bg-amber-100 px-2 py-1 rounded-full text-amber-800 text-xs'>
													...
													{editedRoles.filter(role => role.filled).length > 0 && (
														<span className='inline-flex items-center gap-1 bg-green-100 px-2 py-1 rounded-full text-green-800 text-xs'>
